...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/Movies_1st_On_Telegram'),
...
async def show_help(client, message):
    ...
    if message.chat.type != "private" and message.from_user is None:
        k=await message.reply(
            text="I cant help you here, since you are an anonymous admin and I like Anon Admins 🙂😜. Get help in PM",
            reply_markup=InlineKeyboardMarkup(
                [
                    [
